...
///
#[safety {
    ValidInstance(root_paddr, "page table"): "Changing the level 4 page table is unsafe, because it's possible to violate memory safety by changing the page mapping."
}]
