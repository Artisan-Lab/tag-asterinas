...
impl MetaSlot {
    ...
    //#[safety::precond::Gt(self.ref_count, 0)]
    ...
    //#[safety::precond::PostToFunc(Self::write_meta)]
    ...
    //#[safety::global::MutExclusive(self.vtable_ptr)]
    //#[safety::global::MutExclusive(self.storage)]
    ...
    //#[safety::precond::Eq(self.ref_count, 0)]
    //#[safety::precond::PostToFunc(Self::write_meta)]
...
//#[safety::global::Context(BSP_BUT_AP)]
