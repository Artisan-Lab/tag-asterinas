...
//#[safety::precond::ValidAccess(src, ANY, READ(len))]
//#[safety::precond::ValidAccess(dst, ANY, WRITE(len))]
...
///
/// [valid]: crate::mm::io#safety
//#[safety::precond::ValidAccess(src, ANY, READ(len))] //may lack rigor
//#[safety::precond::ValidAccess(src, ANY, WRITE(len))]
...
impl<'a> VmReader<'a, Infallible> {
    ...
    ///
    /// [valid]: crate::mm::io#safety
    //#[safety::precond::ValidAccess(ptr, ANY, READ(len))]
...
impl VmReader<'_, Fallible> {
    ...
    //#[safety::precond::ValidAccess(ptr, USER, ANY(len))]
...
impl<'a> VmWriter<'a, Infallible> {
    ...
    ///
    /// [valid]: crate::mm::io#safety
    //#[safety::precond::ValidAccess(ptr, ANY, Write(len))]
