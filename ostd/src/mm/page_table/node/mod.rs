...
impl<C: PageTableConfig> PageTableNode<C> {
    ...
    //#[safety::precond::ValidInstance(self)]
    //#[safety::precond::ValidLevel(self, C::NR_LEVELS)]
...
impl<'a, C: PageTableConfig> PageTableNodeRef<'a, C> {
    ...
    //#[safety::precond::RefUnheld(Guard(self))]
...
impl<'rcu, C: PageTableConfig> PageTableGuard<'rcu, C> {
    ...
    //#[safety::precond::ValidIndex(paddr_to_vaddr(self.start_paddr()) as *mut C::E, idx)]
    ...
    ///     after this method.
    //#[safety::precond::ValidIndex(paddr_to_vaddr(self.start_paddr()) as *mut C::E, idx)]
    //#[safety::precond::ValidPteLevel(Child(pte)., self.level() - 1)]
    //#[safety::postcond::Owned(self, Child(pte))]
